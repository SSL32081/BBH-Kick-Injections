...
class SpinQ_Config {
    ...
    srcUrl(type) {
        switch(type) {
            case 'stats':
                return `${input_base}tex_tables/${this.label}_3Dskyloc_tex_table.txt`;
                break;
            case 'kick':
                return `${input_base}kick_plots/${this.label}_3Dskyloc_kick.html`;
                break;
            case 'contour':
                return `${input_base}contour_png/${this.label}_3Dskyloc_all_plots.png`;
                break;
        }
    }
}
