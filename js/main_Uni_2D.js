...
class SpinQ_Config {
    ...
    srcUrl(type) {
        switch(type) {
            case 'stats':
                return `${input_base}tex_tables/${this.label}_Uni_2Dskyloc_tex_table.txt`;
                break;
            case 'kick':
                return `${input_base}kick_plots/${this.label}_Uni_2Dskyloc_kick.html`;
                break;
            case 'contour':
                return `${input_base}contour_png/${this.label}_Uni_2Dskyloc_all_plots.png`;
                break;
        }
    }
}
